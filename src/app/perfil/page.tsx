        ...
        <main>
            ...
            <Section>
                ...
                <div className="perfil">
                    ...
                    <ContainerPerfil>
                        <InputGrupo type="text" placeholder="Nome Completo" icon="bi bi-person-fill" />
                        <InputGrupo type="date"/>
                        <InputGrupo type="email" placeholder="Email" icon="bi bi-envelope-fill" />
                        <div className="senha">
                        <h5>Alterar Senha</h5>
                            <InputGrupo type="password" placeholder="Senha" icon="bi bi-lock-fill" />
                            <InputGrupo type="password" placeholder="Confirmar Senha" icon="bi bi-lock-fill" />
                        </div>
